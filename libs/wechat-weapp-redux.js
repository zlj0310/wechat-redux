                ...
                function connect(mapStateToProps, mapDispatchToProps) {
                    ...
                    return function wrapWithConnect(pageConfig) {
                        ...
                        function onLoad(options) {
                            this.store = app.Store;     //TODO 将store改成Store
                            if (!this.store) {
                        ...
                        return (0, _Object.assign)({}, pageConfig, mapDispatch(app.Store.dispatch), { onLoad: onLoad, onUnload: onUnload });    //TODO 将store改成Store
                    };
                }
